...
Factory for a fully custom animation profile. All parameters default to the same values used by `MotionSpec.Adaptive`, so you only need to override the properties you want to change.
