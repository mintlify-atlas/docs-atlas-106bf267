...
description: "How Spatial organizes its modules into clean layers — Compose UI, core contracts, scene graph, and OpenGL renderer — with strict one-directional dependencies."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Foundation Modules" icon="cubes">
    **`spatial-renderer`** — OpenGL ES 3.0 render pipeline, shader compilation, buffer management, and Choreographer frame scheduling.
